...
public:
	...
	virtual double mana() const { return 0; }
...
public:
	...
	double mana() const override { return _mana; }
...
{
public:
	Monster(int col, int row, char symbol = 'M', int visibility = 5, double damage = 25, double hp = 100) :
